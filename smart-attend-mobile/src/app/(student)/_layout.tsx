...
export default function StudentLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name="scan-qr" options={{ title: 'Scan QR', href: null }} />
      <Tabs.Screen name="analytics" options={{ title: 'Module Analytics', href: null }} />
      <Tabs.Screen name="disputes" options={{ title: 'Disputes', href: null }} />
